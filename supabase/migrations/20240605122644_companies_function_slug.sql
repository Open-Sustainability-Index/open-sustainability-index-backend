...
drop function if exists "public"."companies_v2"(offset_value integer, limit_value integer, sort_by text, sort_order text, industry_filter text, near_term_filter boolean, commitment_type_filter text, commitment_status_filter text, target_target_filter text, emissions_required text);
