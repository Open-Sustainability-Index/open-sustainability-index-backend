...
SELECT -- Basic fields and total_scope_3_summary
 e.company_slug,
 e.year,
 e.fiscal_year, -- Scope 1 and 2
 e.scope_1,
 e.scope_2_market_based,
 e.scope_2_location_based,
 e.scope_2_unknown, -- Scope 3 total from categories, and from summary
 ...
 e.total_scope_3 AS total_scope_3_summary, -- Total emission calculations
 ...
 e.scope_1 + e.scope_2_location_based + COALESCE(e.total_scope_3, (e.cat_1 + e.cat_2 + e.cat_3 + e.cat_4 + e.cat_5 + e.cat_6 + e.cat_7 + e.cat_8 + e.cat_9 + e.cat_10 + e.cat_11 + e.cat_12 + e.cat_13 + e.cat_14 + e.cat_15)) AS total_emission_location_based, -- Totals for 1-2, and 1-2-3
 ...
 (e.scope_1 + COALESCE(e.scope_2_market_based, e.scope_2_location_based, e.scope_2_unknown) + COALESCE(e.total_scope_3, (e.cat_1 + e.cat_2 + e.cat_3 + e.cat_4 + e.cat_5 + e.cat_6 + e.cat_7 + e.cat_8 + e.cat_9 + e.cat_10 + e.cat_11 + e.cat_12 + e.cat_13 + e.cat_14 + e.cat_15))) AS total_reported_emission_scope_1_2_3, -- Category 1-15
 e.cat_1,
 e.cat_2,
 e.cat_3,
 e.cat_4,
 ...
 (e.scope_1 + COALESCE(e.scope_2_market_based, e.scope_2_location_based, e.scope_2_unknown) + (e.cat_1 + e.cat_2 + e.cat_3 + e.cat_4 + e.cat_5 + e.cat_6 + e.cat_7 + e.cat_8)) AS total_upstream_emissions, -- Revenue and currency rate
 e.revenue_local,
 e.currency,
 cr.rate_in_usd AS currency_rate,
 e.revenue_local * cr.rate_in_usd AS revenue, -- Intensity calculations
 (COALESCE(e.total_scope_3, (e.cat_1 + e.cat_2 + e.cat_3 + e.cat_4 + e.cat_5 + e.cat_6 + e.cat_7 + e.cat_8 + e.cat_9 + e.cat_10 + e.cat_11 + e.cat_12 + e.cat_13 + e.cat_14 + e.cat_15)) + e.scope_1 + COALESCE(e.scope_2_market_based, e.scope_2_location_based, e.scope_2_unknown)) / NULLIF(e.revenue_local * cr.rate_in_usd, 0) AS emission_intensity,
 (e.scope_1 + COALESCE(e.scope_2_market_based, e.scope_2_location_based, e.scope_2_unknown) + (e.cat_1 + e.cat_2 + e.cat_3 + e.cat_4 + e.cat_5 + e.cat_6 + e.cat_7 + e.cat_8)) / NULLIF(e.revenue_local * cr.rate_in_usd, 0) AS cradle_to_gate, -- Other fields
 e.ghg_standard,
